        ...
        <div className="bg-white shadow rounded-xl border border-gray-200 overflow-hidden">
          <div className="p-6 sm:p-8">
            <div className="flex items-center mb-6 border-b border-gray-100 pb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Provedor de Inteligência Artificial</h2>
                <p className="text-sm text-gray-500">A chave configurada aqui será injetada de forma segura nas execuções do n8n.</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="llmProvider" className="block text-sm font-medium text-gray-700">Modelo / Provedor</label>
                <select
                  id="llmProvider"
                  value={llmProvider}
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    placeholder={hasApiKey ? '******** (Chave já configurada. Digite para alterar)' : 'sk-...'}
                  />
                </div>
                <p className="mt-2 text-xs text-gray-500">
                  Sua chave será armazenada utilizando criptografia de nível militar (AES-256-GCM) atrelada à sua identidade única. Apenas o sistema de automação conseguirá descriptografá-la.
                </p>
              </div>
